namespace JobHelperGuiBeta1
{
    partial class Reports
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "Godtable";
            reportDataSource1.Value = this.DataTable1BindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "JobHelperGuiBeta1.Report.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new System.Drawing.Size(563, 255);
            ...
            this.DataTable1BindingSource.DataSource = this.God;
            // 
        ...
        private God God;
        private GodTableAdapters.DataTable1TableAdapter DataTable1TableAdapter;
